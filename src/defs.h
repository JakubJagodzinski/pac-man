...
#define FILE_START_GAME_SCREEN "start_game_screen.txt"
#define FILE_MENU_SCREEN "menu_screen.txt"
#define FILE_CONFIRMATION_SCREEN "confirmation_screen.txt"
#define FILE_CHOOSE_DIFFICULTY_SCREEN "choose_difficulty_screen.txt"
#define FILE_HIGH_SCORES_SCREEN "high_scores_screen.txt"
#define FILE_HIGH_SCORE_EASY "high_score_easy.txt"
#define FILE_HIGH_SCORE_MEDIUM "high_score_medium.txt"
#define FILE_HIGH_SCORE_HARD "high_score_hard.txt"
#define FILE_HIGH_SCORE_HARDCORE "high_score_hardcore.txt"
#define FILE_SCOREBOARD_MENU_SCREEN "scoreboard_menu_screen.txt"
#define FILE_SCOREBOARD_SCREEN "scoreboard_screen.txt"
#define FILE_SCOREBOARD_EASY "scoreboard_easy.txt"
#define FILE_SCOREBOARD_MEDIUM "scoreboard_medium.txt"
#define FILE_SCOREBOARD_HARD "scoreboard_hard.txt"
#define FILE_SCOREBOARD_HARDCORE "scoreboard_hardcore.txt"
#define FILE_SETTINGS_SCREEN "settings_screen.txt"
#define FILE_CREDITS_SCREEN "credits_screen.txt"
#define FILE_GAME_OVER_SCREEN "game_over_screen.txt"
#define FILE_GOODBYE_SCREEN "goodbye_screen.txt"
#define FILE_HELP_SCREEN "help_screen.txt"
